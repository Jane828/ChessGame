...
<title>九人斗牌房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $image_url;?>files/css/nbull.css?_version=<?php echo $front_version;?>">
...
<body >
    ...
    ?>
		...
		<div class="table" id="table" style="position: relative; width: 100vh; height: 104vh; top: -20px; z-index: 80; overflow: hidden;">
			<img class="tableBack"  src="<?php echo $image_url;?>files/images/nbull/table.jpg" style="position: absolute;top:0;left: 0;width: 100vw;height: 100vh" />
			...
			<div class="cardOver" style="position: absolute; width: 100%; height: 100%; overflow:hidden;">
				<div v-for="p in player" v-if="p.num!=1" v-show="p.account_status>=8&&p.card_open.length>0&&game.show_card">
					<div class="cards" :class="'card' + p.num + ' card' + p.num + '11'" style="z-index: 14;">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.num + ' card' + p.card_open[4]"></div>
					</div>
					...
					<div class="cards" :class="'card' + p.num + ' card' + p.num + '41'" style="z-index: 11">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[1]"></div>
					</div>

					<div class="cards" :class="'card' + p.num + ' card' + p.num + '51'" style="z-index: 10">
						<div class="face front"></div>
			...
			<div v-for="p in player" v-if="p.num!=1&&ruleInfo.banker_mode!=2" :class="{true:'memberGoText' + p.num,false:'memberRobText' + p.num}[ruleInfo.banker_mode==5]" v-show="p.account_status==4||p.account_status==5">
				<img :src="p.robImg" style="position: absolute; width: 100%;">
			</div>
			...
			<div v-for="p in player"  v-if="p.num==2||p.num==3||p.num==4" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
			...
			<div v-for="p in player"  v-if="p.num==7||p.num==8||p.num==9" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
            ...
            <div key="player[0].num" class="member" :class="'member' + player[0].num" v-show="player[0].account_id>0 && player[0].num==1">
				...
				<img :id="'banker' + player[0].account_id" src="<?php echo $image_url;?>files/images/nbull/banker_bg.png" class="background" style="position: absolute; top: -0.2vh;left: -0.2vh;width: 7.86vh; height: 7.86vh; display: none;" />
			...
			<div  v-for="p in player" key="p.num" class="member" :class="'member' + p.num" v-if="p.num > 1" v-show="p.account_id>0 && p.num!=1" >
				...
				<img :id="'banker' + p.account_id" src="<?php echo $image_url;?>files/images/nbull/banker_bg.png" class="background" style="position: absolute; top: -0.2vh;left: -0.2vh;width: 7.86vh; height: 7.86vh; display: none;" />
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='九人斗牌战绩'>九人斗牌战绩</span>
			</div>
            ...
            <div class="mainPart" >
                ...
                <div class="blueBack">
                    ...
                    <div class="selectPart" :style="'height:' + ruleInfo.rule_height + ';line-height:4vh;padding:0.8vh 0;'">
                        ...
                        <div class="selectList">
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.hasGhost==1">
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/nbull.js?_version=<?php echo $front_version;?>"></script>
