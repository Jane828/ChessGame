...
<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/flower.css?_version=<?php echo $front_version;?>">
...
<body>
	<style>
	  ...
	  .layerGameScore .mainPart .showPart .storeHeader .cardTitle{flex:2; }   
        ...
        layerGameScore over */
        .bottomGameScore{position: fixed;bottom:0.75vh;right: 10vh;width: 6vh; height: 6vh;z-index:90;}
		...
		.autoReady{position: fixed;bottom:14vh; right:0.5vh; height: 4vh;z-index:90;width: 12vh;}
...
<div class="main" id="app-main" style="display: none;'">
	...
	<div class="autoBet" v-if="!isAudience">
	...
	<div  class="table" id="table">
		<img class="tableBack"  src="<?php echo $image_url;?>files/images/flower/toBackground.png" />
	...
	<div class="ranking hideRanking" id="ranking" style="z-index: 1">
		...
		<div class="rankText" style="position: absolute;top: 4%;">
			...
			<div class="owner">
				<img class="ownerImg" src="<?php echo $image_url;?>files/images/common/owner.png" alt="房主">
			</div>
    ...
    <div class="layerGameScore" id="vGameScore" v-show="scoreInfo.isShow">
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='飘三叶战绩'>飘三叶战绩</span>
			</div>
    ...
    <div class="joinOrWatch" v-show="joinChoose.isShow">
		...
		<div class="selectPart" style="height:30px;line-height:30px;padding:6px 0;">
                ...
                <div class="selectPart" style="height:30px;line-height:30px;padding:6px 0;" v-if="game.game_type == 1">
	...
	<!-- 游戏规则-->
	<div class="createRoom" id="vroomRule" v-show="ruleInfo.isShowRule">
		...
		<div class="selectPart" style="height:30px;line-height:30px;padding:6px 0;">
				...
				<div class="selectPart" style="height:30px;line-height:30px;padding:6px 0;">
					<div class="selectTitle">局数：</div>
					<div class="selectList">
						<div class="selectItem"  v-if="ruleInfo.ticket_count==1">
							<div class="selectText" >10局X1张房卡</div>
						</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/flower.js?_version=<?php echo $front_version;?>"></script>
