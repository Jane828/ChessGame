...
<title>九人三公房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/nsg.css?_version=<?php echo $front_version;?>">
...
<body >
	...
	<style>
		...
		.layerGameScore .mainPart .gameStoreTitle{ width:55vw; height:45px; text-align:center; padding-top:5px; position:absolute; top:0; left:50%; transform:translateX(-50%); border-radius:5px; background-image:url("../files/images/common/storetitle.png"); background-size:contain; background-repeat:no-repeat;}
	...
	<div class="main" id="app-main" style="position: relative; width: 100%;margin: 0 auto; background: #fff; display: none;">
		...
		<div class="table" id="table" style="position: relative; width: 100vh; height: 104vh; top: -20px; z-index: 80; overflow: hidden;">
			<img class="tableBack"  src="<?php echo $base_url;?>files/images/sangong/table9.jpg" style="position: absolute;top:0;left: 0;width: 100vw;height: 100vh" />
			...
			<img v-if="isAudience" style="width: 160px; position: absolute; top: 150px; left: calc(50% - 80px);" src="<?php echo $image_url;?>files/images/watch/visiting.png" />
                ...
                <!-- 玩家1摊牌看牌  -->
				<div class="myCards" v-show="player[0].is_showCard&&player[0].account_status==8&&game.show_card&&player[0].card.length>0" >
			...
			<div class="cardOver" style="position: absolute; width: 100%; height: 100%; overflow:hidden;">
				<div v-for="p in player" v-if="p.num!=1" v-show="p.account_status>=8&&p.card.length>0&&game.show_card">
					<div class="cards" :class="'card' + p.num + ' card' + p.num + '11'" style="z-index: 14;">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.num + ' card' + p.card[2]"></div>
					</div>
			...
			<div  v-for="p in player" key="p.num" class="member" :class="'member' + p.num" v-if="p.num > 1" v-show="p.account_id>0 && p.num!=1" >
				...
				<div class="isReady" v-show="game.round!=game.total_num">
					<img src="<?php echo $image_url;?>files/images/common/ready_button.png" class="unready" v-show="(p.account_status==1||p.account_status==0)&&game.status==1&&p.num==1" @click="imReady" />
            ...
            <div id="operationButton" :style="viewStyle.button">
				...
				<div  v-show="game.round!=game.total_num" :style="viewStyle.readyButton" >
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='九人三公战绩'>九人三公战绩</span>
			</div>
        ...
        <div class="joinOrWatch" v-show="joinChoose.isShow">
            ...
            <div class="mainPart" >
                ...
                <div class="blueBack">
                    ...
                    <div class="selectPart" v-if="ruleInfo.isJoker==1||ruleInfo.jsBj==1" style="overflow: hidden;line-height:4vh;padding:0.8vh 0;">
                    ...
                    <div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;">
                        ...
                        <div class="selectList">
                            ...
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.ticket==4">
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/nsg.js?_version=<?php echo $front_version;?>"></script>
