...
<title>十三人斗牌房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/fbull.css?_version=<?php echo $front_version;?>">
...
<body >
	...
	<style>
		...
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(2){ background-image:url("<?php echo $image_url;?>files/images/common/cards3.jpg"); background-size:325px 150px; display:inline-block; width:25px;height:30px;  vertical-align:middle; }
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(3){ background-image:url("<?php echo $image_url;?>files/images/common/cards3.jpg"); background-size:325px 150px; display:inline-block; width:25px;height:30px;  vertical-align:middle;margin-left:-18px; }
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(4){ background-image:url("<?php echo $image_url;?>files/images/common/cards3.jpg"); background-size:325px 150px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(5){ background-image:url("<?php echo $image_url;?>files/images/common/cards3.jpg"); background-size:325px 150px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(6){ background-image:url("<?php echo $image_url;?>files/images/common/cards3.jpg"); background-size:325px 150px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}
		.autoReady{position: fixed;bottom:2vh;right:10vh;height: 4vh;z-index:90;width: 12vh;}
        .autoReady img{display: block; height: 4vh; float: right;}
	</style>
    ...
    ?>
		...
		<div class="table" id="table" style="position: relative; width: 100vh; height: 104vh; top: -20px;z-index: 80; overflow: hidden;">
			...
			<div v-for="p in player"  v-if="p.num==2||p.num==3||p.num==4||p.num==5" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
			...
			<div v-for="p in player"  v-if="p.num==10||p.num==11||p.num==12||p.num==13" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
			...
			<!-- 玩家4得分 -->
			<div  v-for="p in player" v-if="p.num==6||p.num==7||p.num==8||p.num==9" :class="'memberScoreText' + p.num"  v-show="game.show_score" style="display: none;">
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='十三人斗牌战绩'>十三人斗牌战绩</span>
			</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/fbull.js?_version=<?php echo $front_version;?>"></script>
