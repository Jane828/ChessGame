...
<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/vbull9.css">
    ...
    ?>
			...
			<div class="cardOver" style="position: absolute; width: 100%; height: 100%; overflow:hidden;">
				<div v-for="p in player" v-if="p.num!=1" v-show="p.account_status>=8&&p.card_open.length>0&&game.show_card">
					<div class="cards" v-bind:class="'card' + p.num + ' card' + p.num + '11'" style="z-index: 14;">
						<div class="face front"></div>
						<div class="face back" v-bind:class="'card' + p.num + ' card' + p.card_open[4]"></div>
					</div>
        ...
        <div class="ranking hideRanking" id="ranking" style="z-index: 1">
			...
			<div class="rankText" style="position: absolute;top: 4%;">
				<img   src="<?php echo $image_url;?>files/images/nbull/rank_frame.png" style="position: absolute;top: 0%;left: 25vw;width: 150vw;">
				...
				<div v-for="p in playerBoard.score" class="scoresItem" v-bind:class="{true: 'scoresItemYellow', false: 'scoresItemWhite'}[p.account_score>0]" v-show="p.account_id>0">
				    <img   src="<?php echo $image_url;?>files/images/common/rank_bigwinner.png" style="top: 0; margin-top: -2.5vw; left: 2px;height: 100%" v-show="p.isBigWinner==1">
		...
		<div id="endCreateRoom" class="end" style="position: fixed;width: 100%;height:100%;top:0;left:0;z-index: 120;display: none;">
            ...
            <a href="/f/yh" style="position: absolute;bottom:3%;display: block;width:34vw;height:11vw;margin-right: 10%;left: 56vw" ></a>
		</div>
        ...
        <div class="layerGameScore" id="vGameScore" v-show="scoreInfo.isShow" v-on:click="cancelGameScore">
            ...
            <div class="mainPart" style="height: 232px;">
                ...
                <div class="createTitle" style="line-height: 36px;color: #f2ae4a">您的VIP九人斗牌战绩</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/vbull9.js?<?php echo time();?>"></script>
