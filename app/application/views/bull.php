...
<title>六人斗牌房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $image_url;?>files/css/bull.css?_version=<?php echo $front_version;?>">
...
<body >
	...
	<div class="main" id="app-main" style="position: relative; width: 100%;margin: 0 auto; background: #fff; display: none;">
		...
		<div class="myCardType">
		    <div style="font-size: 10pt;"><img src="<?php echo $image_url;?>files/images/common/endPoint.png" alt="底分" class="footImg"><span class="baseScore">{{base_score}}分</span></div>
		</div>
		...
		<div class="table" id="table" style="position: relative; width: 100vh; height: 104vh; top: -20px; z-index: 80; overflow: hidden;">
            ...
            <div  class="memberScoreText1" v-show="game.show_score" style="display: none;">
			    <label v-show="player[0].single_score<0&&player[0].account_status>=8"  style="position: absolute; line-height: 40px; width: 100%; height: 40px; text-align: center;color: white; font-size: 16pt;;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #022055; ">{{player[0].single_score}}</label>
			...
			<div  v-for="p in player" :key="p.num" class="member" :class="'member' + p.num" v-show="p.account_id>0" >
				...
				<img src="<?php echo $image_url;?>files/images/bull/banker_icon.png" class="background" style="position: absolute; top: 3%;left: 3%;width: 18px; height: 18px;" v-show="p.is_banker != 0">
				...
				<div class="isReady" v-show="game.round!=game.total_num">
					<img src="<?php echo $image_url;?>files/images/common/ready_button.png" class="unready" v-show="(p.account_status==1||p.account_status==0)&&p.num==1 && roomStatus < 2 && game.status==1 &&ruleInfo.banker_mode!=5 && !isAudience" @click="imReady" />
					<img src="<?php echo $image_url;?>files/images/common/ready_button.png" class="unready" v-show="(p.account_status==1||p.account_status==0)&&p.num==1 && roomStatus < 2 && game.status==1 &&ruleInfo.banker_mode==5&&canBreak!=1 && !isAudience" @click="imReady" />
            ...
            <div id="operationButton" :style="viewStyle.button" v-if="!isAudience">
            	...
            	<!-- 点击看牌-->
            	<div v-show="showClickShowCard && !isAudience && player[0].account_status == 7" :style="viewStyle.showCardText">
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='六人斗牌战绩'>六人斗牌战绩</span>
			</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/bull.js?_version=<?php echo $front_version;?>"></script>
