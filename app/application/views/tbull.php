...
<title>十二人斗牌房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/tbull.css?_version=<?php echo $front_version;?>">
...
<body >
	...
	<style>
		...
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(2){ background-image:url("<?php echo $image_url;?>files/images/common/cards2.jpg"); background-size:375px 120px; display:inline-block; width:25px;height:30px;  vertical-align:middle; }
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(3){ background-image:url("<?php echo $image_url;?>files/images/common/cards2.jpg"); background-size:375px 120px; display:inline-block; width:25px;height:30px;  vertical-align:middle;margin-left:-18px; }
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(4){ background-image:url("<?php echo $image_url;?>files/images/common/cards2.jpg"); background-size:375px 120px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(5){ background-image:url("<?php echo $image_url;?>files/images/common/cards2.jpg"); background-size:375px 120px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}
		.layerGameScore .mainPart .showPart .storeList .playerMenu .cardType span:nth-child(6){ background-image:url("<?php echo $image_url;?>files/images/common/cards2.jpg"); background-size:375px 120px; display:inline-block; width:25px;height:30px;  vertical-align:middle; margin-left:-18px;}

        .autoReady{position: fixed;bottom:2vh;right:10vh;height: 4vh;z-index:90;width: 12vh;}
        .autoReady img{display: block; height: 4vh; float: right;}
        /*layerGameScore over*/
	</style>
    ...
    ?>
		...
		<div class="audienceLook" @click="showWatch" style="position: fixed;"><img class="lookImg" src="<?php echo $image_url;?>files/images/common/toVisit.png" alt="观战"><span class="lookFont">{{appData.audiences.length}}</span></div>
	        <img class="return" src="<?php echo $image_url;?>files/images/common/toRule.png" @click="showGameRule" />
	        <img class="bottomGameScore" src="<?php echo $base_url;?>files/images/common/score.png" @click="showGameScore">
	        <img class="bottomHistory" src="<?php echo $image_url;?>files/images/common/toSound.png" @click="showAudioSetting">
	        <img class="bottomMessage" src="<?php echo $image_url;?>files/images/common/toChat.png" @click="showMessage">
		...
		<map name="planetmap" id="planetmap">
			<area shape="rect" :coords="'0,0,' + width/3.2 + ',' + width/8"  class="showRanking" />
			<area shape="rect" :coords="width/3*2 + ',0,' + width + ',' + width/8" @click="showMessage" />
		</map>
		...
		<div class="alert" id="valert" v-show="isShowAlert">
			...
			<div class="mainPart" style="height:28vh;">
				...
				<div v-show="alertType==1" v-if="isShop">
					<div class="buttonMiddle" @click="closeAlert">购买房卡</div>
				</div>
				<div v-show="alertType==1" v-if="!isShop">
				...
				<div v-show="alertType==9">
					<div class="buttonMiddle" @click="showBreakRoom"></div>
				</div>
				<div v-show="alertType==10">
				    <div class="buttonLeft" @click="closeAlert"></div>
					<div class="buttonRight" @click="confirmBreakRoom"></div>
				</div>
		...
		<div class="table" id="table" style="position: relative; width: 100vh; height: 104vh; top: -20px; z-index: 80; overflow: hidden;">
			...
			<div class="cardDeal">
				...
				<div class="myCards" v-show="player[0].is_showCard&&player[0].account_status>2&&player[0].account_status<=7&&game.show_card">
					...
					<div class="cards card3" v-show="player[0].account_status >2 && player[0].account_status <= 7">
						<div class="face front" @click="seeMyCard4"></div>
						<div class="face back" :class="'card' + player[0].card[3]"></div>
					</div>

					<div class="cards card4" v-show="player[0].account_status >2 && player[0].account_status <= 7">
						<div class="face front" @click="seeMyCard5"></div>
						<div class="face back" :class="'card' + player[0].card[4]"></div>
					</div>
					</div>
				</div>
				...
				<div class="myCards" v-show="player[0].is_showCard&&player[0].account_status==8&&game.show_card&&player[0].card_open.length>0" >
					<div class="cards card00">
						<div class="face back" :class="'card' + player[0].card_open[0]" style="-webkit-transform: rotateY(0deg);"></div>
					</div>

					<div class="cards card01">
						<div class="face back" :class="'card' + player[0].card_open[1]" style="-webkit-transform: rotateY(0deg);"></div>
					</div>

					<div class="cards card02">
						<div class="face back" :class="'card' + player[0].card_open[2]" style="-webkit-transform: rotateY(0deg);"></div>
					</div>

					<div class="cards card03">
						<div class="face back" :class="'card' + player[0].card_open[3]" style="-webkit-transform: rotateY(0deg);"></div>
					</div>

					<div class="cards card04">
						<div class="face back" :class="'card' + player[0].card_open[4]" style="-webkit-transform: rotateY(0deg);"></div>
					</div>
				</div>
			</div>
			...
			<div class="cardOver" style="position: absolute; width: 100%; height: 100%; overflow:hidden;">
				<div v-for="p in player" v-if="p.num!=1" v-show="p.account_status>=8&&p.card_open.length>0&&game.show_card">
					<div class="cards" :class="'cards' + p.num + ' card' + p.num + '11'" style="z-index: 14;">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[4]"></div>
					</div>

					<div class="cards" :class="'cards' + p.num + ' card' + p.num + '21'" style="z-index: 13">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[3]"></div>
					</div>

					<div class="cards" :class="'cards' + p.num + ' card' + p.num + '31'" style="z-index: 12">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[2]"></div>
					</div>

					<div class="cards" :class="'cards' + p.num + ' card' + p.num + '41'" style="z-index: 11">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[1]"></div>
					</div>

					<div class="cards" :class="'cards' + p.num + ' card' + p.num + '51'" style="z-index: 10">
						<div class="face front"></div>
						<div class="face back" :class="'card' + p.card_open[0]"></div>
					</div>
				</div>
			</div>
			...
			<div v-for="p in player" v-if="p.num!=1&&ruleInfo.banker_mode!=2" :class="{true:'memberGoText' + p.num,false:'memberRobText' + p.num}[ruleInfo.banker_mode==5]" v-show="p.account_status==4||p.account_status==5">
				<img :src="p.robImg" style="position: absolute; width: 80%;">
			</div>
			...
			<div v-for="p in player" v-if="p.num!=1&&ruleInfo.banker_mode==2" :class="'memberGoTimesText' + p.num" v-show="p.account_status==5&&p.bankerMultiples>=1">
				<img :src="p.bankerTimesImg" style="position: absolute; width: 80%;">
			</div>
            ...
            <div class="memberTimesText1" v-if="ruleInfo.banker_mode!=4" v-show="player[0].account_status>=6&&game.show_card&&!player[0].is_banker&&player[0].multiples>0">
            	<img :src="player[0].timesImg" style="position: absolute; width: 100%;">
            </div>
			<div v-for="p in player" v-if="p.num!=1&&ruleInfo.banker_mode!=4" :class="'memberTimesText' + p.num" v-show="p.account_status>=6&&game.show_card&&!p.is_banker&&p.multiples>0">
			    <img :src="p.timesImg" style="position: absolute; width: 100%;">
			</div>
			...
			<div class="memberTimesText1" v-if="ruleInfo.banker_mode==2" v-show="player[0].account_status>=5&&game.show_card&&player[0].is_banker&&player[0].bankerMultiples>0">
            	<img :src="player[0].bankerTimesImg" style="position: absolute; width: 100%;">
            </div>
			<div v-for="p in player" v-if="p.num!=1&&ruleInfo.banker_mode==2" :class="'memberTimesText' + p.num" v-show="p.account_status>=5&&game.show_card&&p.is_banker&&p.bankerMultiples>0">
			    <img :src="p.bankerTimesImg" style="position: absolute; width: 100%;">
			</div>
            ...
            <div  class="memberScoreText1" v-show="game.show_score" style="display: none;">
			    <label v-show="player[0].single_score<0&&player[0].account_status>=8"  style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center;color: white; font-size: 3vh;;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #022055; ">{{player[0].single_score}}</label>
			    <label v-show="player[0].single_score>0&&player[0].account_status>=8"  style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center;color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">+{{player[0].single_score}}</label>
			    <label v-show="player[0].single_score==0&&player[0].account_status>=8"  style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center;color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">0</label>
			</div>

			<div v-for="p in player"  v-if="p.num==2||p.num==3||p.num==4||p.num==5||p.num==6" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
			    <p v-show="p.single_score<0&&p.account_status>=8" style="position: absolute; line-height: 4vh; width:100%;height: 4vh; text-align: right;color: white; font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #022055; ">{{p.single_score}}</p>
			    <p v-show="p.single_score>0&&p.account_status>=8" style="position: absolute; line-height: 4vh; width:100%;height: 4vh; text-align: right;color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">+{{p.single_score}}</p>
			    <p v-show="p.single_score==0&&p.account_status>=8" style="position: absolute; line-height: 4vh; width:100%;height: 4vh; text-align: right;color: rgb(234,171,55); font-size: 3vh;;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00; ">0</p>
			</div>

			<div v-for="p in player"  v-if="p.num==8||p.num==9||p.num==10||p.num==11||p.num==12" :class="'memberScoreText' + p.num" v-show="game.show_score" style="display: none;">
			    <label v-show="p.single_score<0&&p.account_status>=8" style="position: absolute; line-height: 4vh; height: 4vh; text-align: left;color: white; font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #022055; ">{{p.single_score}}</label>
			    <label v-show="p.single_score>0&&p.account_status>=8" style="position: absolute; line-height: 4vh; height: 4vh; text-align: left;color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">+{{p.single_score}}</label>
			    <label v-show="p.single_score==0&&p.account_status>=8" style="position: absolute; line-height: 4vh; height: 4vh; text-align: left;color: rgb(234,171,55); font-size: 3vh;;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">0</label>
			</div>

			<!-- 玩家4得分 -->
			<div  v-for="p in player" v-if="p.num==7" :class="'memberScoreText' + p.num"  v-show="game.show_score" style="display: none;">
			    <label v-show="p.single_score<0&&p.account_status>=8" style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center; color: white; font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #022055; ">{{p.single_score}}</label>
			    <label v-show="p.single_score>0&&p.account_status>=8"  style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center; color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">+{{p.single_score}}</label>
			    <label v-show="p.single_score==0&&p.account_status>=8" style="position: absolute; line-height: 4vh; width: 100%; height: 4vh; text-align: center; color: rgb(234,171,55); font-size: 3vh;font-family:'Helvetica 微软雅黑'; -webkit-text-stroke-width: 1.3px;text-shadow: 1px 2px 2px #782a00;">0</label>
			</div>


			<!-- 玩家  -->
            <div key="player[0].num" class="member" :class="'member' + player[0].num" v-show="player[0].account_id>0 && player[0].num==1">
            	<!-- 玩家头像 -->
                <div class="avatar" style="height: 40px">
                    <img :src="player[0].headimgurl" class="headImg">
                    <img src="<?php echo $image_url;?>files/images/watch/watching.png" class="watching" v-show="player[0].account_status==9">
                </div>
				...
				<div class="bottom" style="background-color: rgba(0, 0, 0, 0.6); border-radius: 2px;overflow: hidden;">
					<div class="bname" style="text-align: center;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">{{player[0].nickname}}</div>
					<div class="bscore" style="text-align: center;overflow: hidden;">{{player[0].account_score}}</div>
				</div>

				<img :id="'banker' + player[0].account_id" src="<?php echo $image_url;?>files/images/nbull/banker_bg.png" class="background" style="position: absolute; top: -0.2vh;left: -0.2vh;width: 6.4vh; height: 6.4vh; display: none;" />
				...
				<img :id="'bankerAnimate' + player[0].num" src="<?php echo $image_url;?>files/images/nbull/banker_animate.png" style="position: absolute; top: -0.2vh; left: -0.2vh; width: 7.86vh; height: 7.86vh; display: none;">
				<img :id="'bankerAnimate1' + player[0].num" src="<?php echo $image_url;?>files/images/nbull/banker_animate.png" style="position: absolute; top: -0.2vh; left: -0.2vh; width: 7.86vh; height: 7.86vh; display: none;">
			...
			<div  v-for="p in player" key="p.num" class="member" :class="'member' + p.num" v-if="p.num > 1" v-show="p.account_id>0 && p.num!=1" >
				<!-- 玩家头像 -->
                <div class="avatar" style="height: 40px">
				...
				<div class="bottom" style="background-color: rgba(0, 0, 0, 0.6); border-radius: 2px;overflow: hidden;">
					<div class="bname" style="text-align: center;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">{{p.nickname}}</div>
					<div class="bscore" style="text-align: center;overflow: hidden;">{{p.account_score}}</div>
				</div>

				<img :id="'banker' + p.account_id" src="<?php echo $image_url;?>files/images/nbull/banker_bg.png" class="background" style="position: absolute; top: -0.2vh;left: -0.2vh;width: 6.4vh; height: 6.4vh; display: none;" />
				...
				<img :id="'bankerAnimate' + p.num" src="<?php echo $image_url;?>files/images/nbull/banker_animate.png" style="position: absolute; top: -0.2vh; left: -0.2vh; width: 7.86vh; height: 7.86vh; display: none;">
				<img :id="'bankerAnimate1' + p.num" src="<?php echo $image_url;?>files/images/nbull/banker_animate.png" style="position: absolute; top: -0.2vh; left: -0.2vh; width: 7.86vh; height: 7.86vh; display: none;">
				...
				<div class="isReady" v-show="game.round!=game.total_num">
					<img src="<?php echo $image_url;?>files/images/common/ready_button.png" class="unready" v-show="(p.account_status==1||p.account_status==0)&&p.num==1" @click="imReady" />
            ...
            <!-- 按钮操作区域 -->
            <div id="operationButton" :style="viewStyle.button" v-if="!isAudience">

				<div v-show="game.round!=game.total_num" :style="viewStyle.readyText">
				...
				<div v-show="game.round!=game.total_num&&(player[0].account_status==1||player[0].account_status==0)&&player[0].num==1&&game.status==1&&player[0].account_id>0&&canBreak!=1" :style="viewStyle.readyButton" > 
					<img src="<?php echo $image_url;?>files/images/common/ready_button.png" style="position: absolute; width: 100%; height: 100%;" />
					<div style="position: absolute;width: 100%;height: 100%" @click="imReady"></div>
				</div>
                ...
                <!-- 第1个倍数 -->
                <div class="divCoin" v-show="showTimesCoin&&!player[0].multiples>0 && !player[0].is_banker&&player[0].account_status>=6" @click="selectTimesCoin(ruleInfo.times1)" :style="viewStyle.times1">
                    <img src="<?php echo $image_url;?>files/images/bull/button_times.png" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%">
                    <div :style="viewStyle.timesText">{{ruleInfo.times1}}倍</div>
                </div>

                <!-- 第2个倍数 -->
                <div class="divCoin" v-show="showTimesCoin&&!player[0].multiples>0&& !player[0].is_banker&&player[0].account_status>=6" @click="selectTimesCoin(ruleInfo.times2)" :style="viewStyle.times2">
                    <img src="<?php echo $image_url;?>files/images/bull/button_times.png" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%">
                    <div :style="viewStyle.timesText">{{ruleInfo.times2}}倍</div>
                </div>

                <!-- 第3个倍数 -->
                <div class="divCoin" v-show="showTimesCoin&&!player[0].multiples>0&& !player[0].is_banker&&player[0].account_status>=6" @click="selectTimesCoin(ruleInfo.times3)" :style="viewStyle.times3">
                    <img src="<?php echo $image_url;?>files/images/bull/button_times.png" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%">
                    <div :style="viewStyle.timesText">{{ruleInfo.times3}}倍</div>
                </div>

                <!-- 第4个倍数 -->
                <div class="divCoin" v-show="showTimesCoin&&!player[0].multiples>0&& !player[0].is_banker&&player[0].account_status>=6" @click="selectTimesCoin(ruleInfo.times4)" :style="viewStyle.times4">
                    <img src="<?php echo $image_url;?>files/images/bull/button_times.png" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%">
                    <div :style="viewStyle.timesText">{{ruleInfo.times4}}倍</div>
                </div>
        ...
        <div class="ranking hideRanking" id="ranking" style="z-index: 1">
			...
			<div class="rankText" style="position: absolute;top: 4%;">
				<img   src="<?php echo $image_url;?>files/images/tbull/ranking.png" style="position: absolute;top: 0;left: 25vw;width: 150vw; height: 300vw;">
				<div class="time" v-show="playerBoard.round>0" style="position: absolute;top: 42vw;width: 100%;">
					<a style="font-size: 6vw;  background-color: rgba(251, 240, 214, 0.6);" >房间号:{{game.room_number}}&nbsp&nbsp&nbsp&nbsp{{playerBoard.record}}&nbsp&nbsp&nbsp&nbsp{{game.total_num}}局</a>
				</div>
		...
		<div class="message" v-show="isShowMessage" >
        	<div class="messageBack" style="z-index: 999" @click="hideMessage"></div>
        	<div class="textPartOuter" style="z-index: 999"></div>
        	<div id="message-box" class="textPart" :style="'height: ' + 0.39 * height + 'px;z-index: 999'">
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='十二人斗牌战绩'>十二人斗牌战绩</span>
			</div>
                ...
                <div class="blueBack">
                    <div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;">
                        ...
                        <div class="selectList">
                            ...
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.banker_mode==3">
                                <div class="selectText" >牛牛上庄</div>
                            </div>
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.banker_mode==4">
                                <div class="selectText" >通比牛牛</div>
                            </div>
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.banker_mode==5">
                    ...
                    <div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;">
                        ...
                        <div class="selectList" >
                            ...
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.baseScore==6">
                                <div class="selectText">2分</div>
                            </div>
							<div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.baseScore==7">
                                <div class="selectText">{{ruleInfo.customScore}}分</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="selectPart" :style="'height:' + ruleInfo.rule_height + ';line-height:4vh;padding:0.8vh 0;'">
                        ...
                        <div class="selectList">
                            ...
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.isStraight==1">
                                <div class="selectText" >顺子牛(6倍)</div>
                            </div>
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.isFlush==1">
                                <div class="selectText" >同花牛(6倍)</div>
                            </div>
                            <div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.isHulu==1">
							...
							<div class="selectItem" style="margin-left:10px;" v-if="ruleInfo.isStraightflush==1">
                    ...
                    <div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;" v-if="ruleInfo.banker_mode==5">
                        ...
                        <div class="selectList">
                            ...
                            <div class="selectItem" style="margin-left:8px;" v-if="ruleInfo.banker_score==2">
                                <div class="selectText">300</div>
                            </div>
                            <div class="selectItem" style="margin-left:8px;" v-if="ruleInfo.banker_score==3">
                                <div class="selectText">500</div>
                            </div>
                            <div class="selectItem" style="margin-left:8px;" v-if="ruleInfo.banker_score==4">
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/tbull.js?_version=<?php echo $front_version;?>"></script>
