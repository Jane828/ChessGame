...
<div class="main" ng-controller="myCtrl" style="display: none;">
    ...
    <div class="game-set">
        <ul>
            ...
            <li class="set-item" ng-click="showGameList('dps')">
                <img src="<?php echo $image_url;?>files/images/hall/dps.png">
            </li>
        </ul>
    </div>
    <div class="game-list" ng-show="createInfo.isShowGame">
        ...
        <div class="game-list-box" ng-click="hideGameList();">
            <ul>
                ...
                <li class="list-item" ng-if="createInfo.gameList=='dps'" ng-click="createDpoint($event)">
                    <img src="<?php echo $image_url;?>files/images/hall/list-dp.png" class="game">
                </li>
            </ul>
        <div>
...
<style>
    ...
    .createRoom .mainPart .blueBack .chipItems select{display: block;margin-top: 0.6vh;height: 3.4vh;width: 9vh;}
    .createRoom .mainPart .blueBack .timeItems span,
    .createRoom .mainPart .blueBack .timeItems select{float: left;}
    /*修改下拉框样式*/
    ...
    /*修改下拉框样式*/
    .createRoom .mainPart .blueBack .timeItems select{display: block;width: 9vh;margin: 0.6vh 0 0 0.5vh;height: 3.4vh;vertical-align: middle;}
    ...
    /***************************************************暗宝配置样式start***************************************************************/
    .createRoom .mainPart .blueBack .dpointRull .selectPartOdds .selectList{float: left; width: 38vh;position: relative;padding-left: 7vh;}
    .createRoom .mainPart .blueBack .dpointRull .selectPartOdds .selectRoundList{float: left; width: 32vh; padding-top:1.2vh;}
    .createRoom .mainPart .blueBack .dpointRull .selectPartOdds .selectList .selectItem{margin-left:1.6vh;min-width: 10vh; }
    .createRoom .mainPart .blueBack .dpointRull .selectPartOdds .selectList .selectItem.selectItemTitle{min-width:0!important;position: absolute;left: 0;top: 0;}
    .createRoom .mainPart .blueBack .dpointRull .selectPartOdds .selectList .selectItemTitle p{line-height: initial;color: #714D29;font-size: 12px;}
    /***************************************************暗宝配置样式end*****************************************************************/
...
<div class="createRoom" ng-show="createInfo.isShow>0">
	...
	<div class="mainPart">
        ...
        <div class='showPart'>
            <div class="selectPartTitle">创建房间,游戏未进行不消耗房卡呦</div>
            <!--10人暗宝模式选择 start-->
            <div style="width: 45vh; margin: auto; position: relative; height: 5.4vh;line-height: 2.7vh;" ng-if="createInfo.isShow==61">
                <div ng-class="{true: 'bankerSelected', false: 'bankerUnSelected'}[createInfo.dpoint.banker_mode==1]" style="left: 9.9vh;" ng-click="selectBankerDpoint(1)">
                    <img ng-src="<?php echo $image_url;?>files/images/common/mode_{{createInfo.dpoint.banker1}}.png" class="img" v-if="createInfo.dpoint.banker_mode!=1">
                ...
                <div ng-class="{true: 'bankerSelected', false: 'bankerUnSelected'}[createInfo.dpoint.banker_mode==2]" style="left: 18.45vh;" ng-click="selectBankerDpoint(2)">
                    <img ng-src="<?php echo $image_url;?>files/images/common/mode_{{createInfo.dpoint.banker2}}.png" class="img" v-if="createInfo.dpoint.banker_mode!=2">
                ...
                <div ng-class="{true: 'bankerSelected', false: 'bankerUnSelected'}[createInfo.dpoint.banker_mode==3]" style="left: 27vh;" ng-click="selectBankerDpoint(3)">
                    <img ng-src="<?php echo $image_url;?>files/images/common/mode_{{createInfo.dpoint.banker3}}.png" class="img" v-if="createInfo.dpoint.banker_mode!=3">
                    <p style="position: absolute;top: 0.4vh;left: 0; width: 100%;height: 2.7vh;text-align: center;">开房</p>
                    <p style="position: absolute;top: 2.7vh;left: 0; width: 100%;height: 2.7vh;text-align: center;">做庄</p>
                </div>
            </div>
            <!--10人暗宝模式选择 end-->
            ...
            <div class="blueBack">
                ...
                <div class="dpointRull" ng-if="createInfo.isShow==61">
                    <div class="selectPart chipItems">
                        <div class="selectTitle">筹码：</div>
                        <div class="selectList" >
                            <div class="selectItem"  ng-click="selectChange(1,1)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.chip_type.indexOf(10) !== -1"/>
                                </div>
                                <div class="selectText" >10、20、30、50、100</div>
                            </div>
                        </div>
                    </div>
                    <div class="selectPart">
                        ...
                        <div class="selectList">
                            <div class="limitChoose selectItem" style="height: 2.5vh;display: flex; align-items: center; justify-content: space-between">
                            <div class="limitChooseProgressReduce" ng-click="downUpperLimit('dp10')"></div>
                            <div class="limitChooseProgressText" style="height: auto !important;">{{createInfo.dpoint.upper_limit == 0? '无上限': createInfo.dpoint.upper_limit}}</div>
                            <div class="limitChooseProgress">
                                <input type="range" min="0" max="2000" step="100"
                                class="limitChooseRange"
                                ng-style="{'background-size': (createInfo.dpoint.upper_limit)/20+ '% 100%'}"
                                ng-model="createInfo.dpoint.upper_limit" />
                            </div>
                            <div class="limitChooseProgressAdd" ng-click="upUpperLimit('dp10')"></div>
                        </div>
                    </div>
                    <div class="selectPart selectPartOdds">
                        <div class="selectTitle">赔率：</div>
                        <br/>
                        <div class="selectList" >
                            <div class="selectItem selectItemTitle">
                                <p style="line-height: initial;">龙、虎</p>
                                <p style="line-height: initial;">出、入</p>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(5,3)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.first_lossrate == 3"/>
                                </div>
                                <div class="selectText" >1:3</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(5,2.9)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.first_lossrate == 2.9"/>
                                </div>
                                <div class="selectText" >1:2.9</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(5,2.8)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.first_lossrate == 2.8"/>
                                </div>
                                <div class="selectText" >1:2.8</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(5,2.7)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.first_lossrate == 2.7"/>
                                </div>
                                <div class="selectText" >1:2.7</div>
                            </div>
                        </div>
                        <br/>
                        <div class="selectList" >
                            <div class="selectItem selectItemTitle">
                                <p style="line-height: 5vh;">同、粘</p>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(6,2)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.second_lossrate == 2"/>
                                </div>
                                <div class="selectText" >1:2</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(6,1.9)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.second_lossrate == 1.9"/>
                                </div>
                                <div class="selectText" >1:1.9</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(6,1.8)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.second_lossrate == 1.8"/>
                                </div>
                                <div class="selectText" >1:1.8</div>
                            </div>
                        </div>
                        <br/>
                        <div class="selectList" >
                            <div class="selectItem selectItemTitle">
                                <p style="line-height: 5vh;">角、串</p>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(7,1)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.three_lossrate == 1"/>
                                </div>
                                <div class="selectText" >1:1</div>
                            </div>
                            <div class="selectItem"  ng-click="selectChange(7,0.9)">
                                <div class="selectBox">
                                    <img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.three_lossrate == 0.9"/>
                                </div>
                                <div class="selectText" >1:0.9</div>
                            </div>
                        </div>
                    </div>
                    <div class="selectPart timeItems" style="height:13vh;">
                        <div class="selectTitle">时间：</div>
                        <div class="selectList" >
                            <label class="selectItem" style="position: relative;">
                                <span style="color:#633201;">准备</span>
                                <select class="flowerReadySelect" ng-model="createInfo.dpoint.countDown[0]" ng-options="x for x in defaultTime5To30">
                                </select>
                                <div class="readySelectIcon">
                                    <div class="sanjiao"></div>
                                </div>
                            ...
                            <label class="selectItem" style="position: relative;">
                                <span style="color:#633201;">抢庄</span>
                                <select class="flowerChipSelect" ng-model="createInfo.dpoint.countDown[1]" ng-options="x for x in defaultTime5To30">
                                </select>
                                <div class="readySelectIcon">
                                    <div class="sanjiao"></div>
                                </div>
                            ...
                            <label class="selectItem" style="position: relative;">
                                <span style="color:#633201;">放宝</span>
                                <select class="flowerChipSelect" ng-model="createInfo.dpoint.countDown[2]" ng-options="x for x in defaultTime5To20">
                                </select>
                                <div class="readySelectIcon">
                                    <div class="sanjiao"></div>
                                </div>
                            ...
                            <label class="selectItem" style="position: relative;">
                                <span style="color:#633201;">下注</span>
                                <select class="flowerChipSelect" ng-model="createInfo.dpoint.countDown[3]" ng-options="x for x in defaultTime5To30">
                                </select>
                                <div class="readySelectIcon">
                                    <div class="sanjiao"></div>
                                </div>
                            ...
                            <label class="selectItem" style="position: relative;">
                                <span style="color:#633201;">开奖</span>
                                <select class="flowerChipSelect" ng-model="createInfo.dpoint.countDown[4]" ng-options="x for x in defaultTime5To10">
                                </select>
                                <div class="readySelectIcon">
                                    <div class="sanjiao"></div>
                                </div>
                    ...
                    <div class="selectPart" style="height:5.5vh;">
                        ...
                        <div class="selectList">
                            <div class="selectItem" ng-click="selectChange(3,2)">
                                <div class="selectBox" ><img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.ticket_count==2" /></div>
                                <div class="selectText" >12局X2房卡</div>
                            </div>
                            <div class="selectItem" ng-click="selectChange(3,4)">
                                <div class="selectBox" ><img src="<?php echo $image_url;?>files/images/common/tick.png" ng-show="createInfo.dpoint.ticket_count==4" /></div>
                                <div class="selectText">24局X4房卡</div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    var socketData = {
        ...
        'dpoint': "<?php echo $socket_treasure?>"
    };
