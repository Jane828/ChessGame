...
var socketModule = {
    ...
    processGameRule: function(obj) {
        if (obj.data.ticket_type) {
            ...
            appData.ruleInfo.hasGhost = Math.ceil(obj.data.has_ghost);
                ...
                if (appData.player[i].is_audiobull == false && appData.player[i].account_status >= 8) {
                    ...
                    setTimeout(function() {
                        if (cardType == 1) {
                            ...
                            mp3AudioPlay("audioBull" + obj.data.combo_point);
                        }
                    }, 100);
...
var methods = {
    ...
    backHome: viewMethods.backHome,
    showWatch: viewMethods.showWatch,
...
function getRuleHeight(){
    ...
    return parseInt(data.isCardbomb, 10) + data.hasGhost + data.isCardfour + data.isCardfive + data.isStraight + data.isStraightflush + data.isCardtiny + data.isHulu +data.isFlush;
}
