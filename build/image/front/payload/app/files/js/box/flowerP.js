var flowerP = {
        ...
        <img :src="baseUrl + 'close.png'" class="flowerP-close" @click="cancelFlowerP">
            ...
            <div class="flowerP-show">
                    ...
                    <div class="flowerP-property">
                        ...
                        <div class="flowerP-seen">
                            ...
                            <div class="flowerP-score-property">
                                ...
                                <div class="flowerP-seen-range">
                                    <img :src="baseUrl+'reduce.png'" class="seen-select-reduce">
                                    <span class="seen-range-value">{{(seenValue === '0') ? '无上限' : seenValue}}</span>
                                    ...
                                    <img :src="baseUrl+'add.png'" class="seen-select-add">
                                </div>
                            </div>
                        </div>
                        <div class="flowerP-compare">
                            ...
                            <div class="flowerP-score-property">
                                ...
                                <div class="flowerP-seen-range">
                                    <img :src="baseUrl+'reduce.png'" class="seen-select-reduce" @click="">
                                    <span class="seen-range-value">{{(compareValue === '0') ? '无上限' : compareValue}}</span>
                        ...
                        <div class="flowerP-up">
                            ...
                            <div class="flowerP-score-property">
                                <div class="flowerP-seen-range">
                                    <img :src="baseUrl+'reduce.png'" class="seen-select-reduce">
                                    <span class="seen-range-value">{{(limitValue === '0') ? '无上限' : limitValue}}</span>
                ...
                <div class="flowerP-save">
                    <img :src="baseUrl+'box-save.png'" alt="保存"  @click="saveFlowerBox">
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        ...
        saveFlowerBox(){
            ...
            if((this.gameTitle==='flower') || (this.gameTitle==='tflower')){
                postData.data.allow235GTPanther = (this.allow235GTPanther) ? 1 : 0;
            }
