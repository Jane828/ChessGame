...
var httpModule = {
    ...
    getScoreInfo: function () {
        reconnectSocket();
        appData.is_connect = true;
        Vue.http.post(globalData.baseUrl + 'f/scoreStat', {'type':91}).then(function (response) {
...
var socketModule = {
    ...
    processJoinRoom: function(obj) {
        ...
        console.log('resetMyAccountStatus');
        ...
        try {
            ...
            for (s in scores) {
                ...
                appData.playerBoard.score.push({
                    ...
                    "account_score": Math.ceil(scores[s].score),
                    "consume_score": Math.ceil(scores[s].consume) > 0 ? Math.ceil(scores[s].consume) : '',
                    "num": num
                });
            }
            //对积分榜排序
...
var viewMethods = {
    ...
    gameOverNew: function(board, balance_scoreboard) {
        ...
        for (var i = 0; i < appData.playerBoard.score.length; i++) {
            ...
            appData.playerBoard.score[i].consume_score = '';
...
var audioModule = {
    ...
    loadAllAudioFile: function() {
        ...
        var audioUrl = ["nobanker.m4a", "robbanker.m4a", "nobull.m4a", "bull1.m4a", "bull2.m4a", "bull3.m4a", "bull4.m4a", "bull5.m4a", "bull6.m4a", "bull7.m4a", "bull8.m4a", "bull9.m4a", "bull10.m4a", "bullflower.m4a", "bullbomb.m4a", "bulltiny.m4a", "times1.m4a", "times2.m4a", "times3.m4a", "times4.m4a", "times5.m4a", "times6.m4a", "times8.m4a", "times10.m4a", "coin.mp3", "audio1.m4a"];
        var audioName = ["audioNoBanker", "audioRobBanker", "audioBull0", "audioBull1", "audioBull2", "audioBull3", "audioBull4", "audioBull5", "audioBull6", "audioBull7", "audioBull8", "audioBull9", "audioBull10", "audioBull11", "audioBull12", "audioBull13", "audioTimes1", "audioTimes2", "audioTimes3", "audioTimes4", "audioTimes5", "audioTimes6", "audioTimes8", "audioTimes10", "audioCoin", "audio1"];
