...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/vflower10.css?<?php echo time();?>">
    <link rel="stylesheet" type="text/css" href="<?php echo $image_url;?>files/css/alert.css?<?php echo time();?>">
    <script type="text/javascript" src="<?php echo $image_url;?>files/js/fastclick.js?<?php echo time();?>"></script>
...
<style>
    ...
    .bottomGameScore{position: fixed;top:15;right: 50px;width: 30px; height: 30px;z-index:90;}
    /*layerGameScore over*/
</style>
...
<div class="main" id="app-main" style="display: none;'">
    ...
    <div class="layerGameScore" id="vGameScore" v-show="scoreInfo.isShow" v-on:click="cancelGameScore">
        ...
        <div class="mainPart" style="height: 232px;">
            ...
            <div class="createTitle" style="line-height: 36px;color: #f2ae4a">您的VIP十人飘三叶战绩</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/vflower10.js?<?php echo time();?>"></script>
