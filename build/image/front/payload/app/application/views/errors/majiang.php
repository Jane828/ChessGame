...
<link rel="stylesheet" href="<?php echo $file_url;?>files/d_<?php echo $dealer_num;?>/css/loading.css">
<link rel="stylesheet" href="<?php echo $file_url;?>files/d_<?php echo $dealer_num;?>/css/majiang/majiang-1.0.2.css">
<style type="text/css">
.ranking .rankText .backY{background:url("<?php echo $file_url;?>files/d_2/images/ranking/majiang4.png");background-size:100%; }
.ranking .rankText .backB{background:url("<?php echo $file_url;?>files/d_2/images/ranking/majiang3.png");background-size:100%;}
.center{position: absolute;width:12.3%;height:19.9%;top:40%;left:44%;background: url("<?php echo $file_url;?>files/d_2/images/majiang/center.jpg");background-size:100%;}
.center .greenLight{position: absolute;width:96%;height:26%;background: url("<?php echo $file_url;?>files/d_2/images/majiang/greenLight.png");background-size:100%;}
.center .back{position: absolute;width:100%;height:100%;top:0;left:0;text-align: center;background: url("<?php echo $file_url;?>files/d_2/images/majiang/centerBack.png");background-size:100%;}
.main{-webkit-transform: rotate(90deg);background: url("<?php echo $file_url;?>files/d_2/images/majiang/table.jpg");position:absolute;}
</style>

<link rel="stylesheet" href="<?php echo $file_url;?>files/d_<?php echo $dealer_num;?>/css/common/majiangAlert.css">
...
<div class="main" style="display: none;z-index: 1;position: fixed;">
	...
	<div class="createRoom" v-show="isShowRull"  v-on:click="closeRull()">
		...
		<div class="mainPart" >			
			...
			<div class="createTitle">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/rullTitle.png" />
			</div>				
			<div class="blueBack">
	...
	<div class="roomCard" v-on:click="showShop()">
		<img  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/roomCard.png" />
		<div class="num">
			<div class="back" ></div>
	...
	<div class="endMa" v-show="game.isShowEnd">
		...
		<div v-show="game.endStep<6&&game.horse_count>1">
			<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/paoma.png" class="title" />
			<div class="card" v-for="m in game.ma" v-if="m.num<4" v-bind:style="'margin-left: '+(12*m.num)+'%;'">
				<div class="animate">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang5.png" class="outer" v-show="game.endStep==0"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma2.png" class="outer" v-show="game.endStep==1"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma3.png" class="outer" v-show="game.endStep==2"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma4.png" class="outer" v-show="game.endStep==3"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" v-show="game.endStep==4||game.endStep==5"/>
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(m.card%100)+'.png'" class="inner" v-if="game.endStep==4||game.endStep==5" />	
		...
		<div v-if="game.endStep<6&&game.horse_count==1">
			...
			<div class="card baozha" >
				<div class="animate">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zifront.png" class="rotatelight" v-show="game.endStep==5" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang5.png" class="outer" v-show="game.endStep==0"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma2.png" class="outer" v-show="game.endStep==1"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma3.png" class="outer" v-show="game.endStep==2"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma4.png" class="outer" v-show="game.endStep==3"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer donghua" v-show="game.endStep==4||game.endStep==5"/>
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.ma[0].card%100)+'.png'" class="inner donghua" v-if="game.endStep==4||game.endStep==5" />
	...
	<div class="readyBox" v-show="player[0].ticket_checked==0">
		<div class="back"></div>
		<div class="blueBack">
			<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/createroom1.png" class="imgBack">
			<div class="infoPart">
				<div class="rule">
			...
			<div class="ready01" v-on:click="click(0)" v-show="player[0].account_status==0||player[0].account_status==1" >
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/rankb1.png"  />
				<div style="position: relative;">准备</div>		
			</div>
			<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ready.png" class="ready02" v-show="player[0].account_status==2"/>
		</div>
	</div>
	<!--功能按钮-->
	<div class="spbutton rullButton" v-on:click="showRull()"><img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/rull.png"></div>
	<div class="spbutton sphome" v-on:click="showAlert(3,'确认返回主页？')"><img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/home.png"></div>
	
	<!-- <div class="spbutton spadd"  v-on:click="showInvite()" ><img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/addPerson.png"></div> -->
	<div class="spbutton recordButton" v-on:click="showAudioSetting()"><img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/icon_sound91.png"></div>	
	<div class="spbutton spaudio"  id="speak" style="display: none" >
		<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/audio.png" >	
		<div class="meng" ></div>
	</div>	
	
	<div class="spbutton spaudio"  v-on:click="showMessage()"><img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/message.png"></div>	
	...
	<div class="playGround">	
		...
		<div class="center" v-show="game.joker!=1||(animate.animate3==8)">
			...
			<div class="back">
				...
				<div class="down" v-show="game.status==2">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang2.1.png"  />X {{game.remain_count}}
				</div>
			</div>
		</div>	
		<!--玩家信息-->
		<div class="playerPart">
			<div v-bind:class="'player player'+p.num" v-for="p in player" v-if="p.account_id>0" >
				<div class="avatar">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/avatarback.png" class="avatar1"/>
				...
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ready.png" class="ready"v-show="p.account_status==2&&p.num!=1" />
			</div>
		</div>
		...
		<div class="fanguipai" v-if="game.joker==1">
			<div class="guipaifront">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang5.png" class="outer" v-show="animate.animate3==1"/>
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma2.png" class="outer" v-show="animate.animate3==2"/>
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma3.png" class="outer" v-show="animate.animate3==3"/>
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ma4.png" class="outer" v-show="animate.animate3==4"/>
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" v-show="animate.animate3==5"/>
				<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.flip_card%100)+'.png'" class="inner" v-if="animate.animate3==5&&game.flip_card>0" />	
			</div>			
			<div class="guipai1" v-show="animate.animate3==6">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zifront.png" class="lightRotate" />			
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer donghua" />
				<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.joker_card%100)+'.png'" class="inner donghua" v-if="game.joker_card>0" />
					
			</div>	
			<div class="guipai2Back"  v-show="animate.animate3>6"></div>		
			<div class="guipai2" v-show="animate.animate3==7">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" />
				<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.joker_card%100)+'.png'" class="inner" v-if="game.joker_card>0" />	
			</div>				
			<div class="guipai3" v-show="animate.animate3==8">
				<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.joker_card%100)+'.png'" class="inner" v-if="game.joker_card>0" style="top:10%;height:85%;left:3%;width:94%;"/>	
			</div>		
		...
		<div class="mine">
			<div class="ready" v-show="player[0].ticket_checked==1">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/readyButton.png" class="readyButton" v-show="player[0].account_status==0||player[0].account_status==1" v-on:click="click(0)"/>
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ready.png" class="isReady" v-show="player[0].account_status==2"/>
			</div>
			<div class="myCard" v-show="player[0].account_status==4">
				<div v-for="c in player[0].card" class="card"  v-on:click="chooseCard(c.num)" v-show="!player[0].end_show" style="height: 94%;">
					<div v-show="c.num>=animate.animate2" style="position: absolute;top:0;left:0;width: 100%;height:100%;" v-bind:class="{true: 'isSelect', false: 'notSelect'}[c.isSelect]">
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/animate2.png" class="outer" v-show="animate.animate1==2||(animate.animate1==5&&(c.num<animate.animate2+4||animate.animate2==8))" style="margin-top:20%;"/>
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/animate1.png" class="outer" v-show="animate.animate1==3||(animate.animate1==6&&(c.num<animate.animate2+4||animate.animate2==8))"/>
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" v-show="animate.animate1==0||animate.animate1==1||(animate.animate1==4||(c.num>=animate.animate2+4&&animate.animate2!=8&&animate.animate1>4))" />
						
						<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(c.card%100)+'.png'" class="inner" v-if="(animate.animate1==0||animate.animate1==1||animate.animate1==4||(c.num>=animate.animate2+4&&animate.animate2!=8&&animate.animate1>4))&&c.card>0" />
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="(animate.animate1==0||animate.animate1==1||animate.animate1==4||(c.num>=animate.animate2+4&&animate.animate2!=8&&animate.animate1>4))&&c.card<100" />
					</div>	
				...
				<div v-for="c in player[0].card" class="endCard" v-if="player[0].end_show">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" />
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(c.card%100)+'.png'" class="inner" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="c.card<100" />	
				</div>			
			</div>			
			<div class="pengGang" v-for="p in player[0].pengGang">
				<div class="card"  v-bind:style="'margin-left: '+(0+(p.num*18))+'%;'" v-show="p.type==1||p.type==2">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" />
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(p.card%100)+'.png'" class="inner" />
				</div>
				<div class="card"  v-bind:style="'margin-left: '+(0+(p.num*18))+'%;'" v-show="p.type==3">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang2.1.png" class="outer" />
				</div>
			...
			<div class="cardNew" v-bind:class="{true: 'isSelect', false: 'notSelect'}[player[0].cardNew.isSelect]" v-on:click="chooseCard(-1)" v-if="player[0].account_status==4&&player[0].cardNew.isShow&&!player[0].end_show&&animate.animate2==0" >
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" />	
				<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[0].cardNew.card%100)+'.png'" class="inner" />
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="player[0].cardNew.card<100" />		
			</div>	
			...
			<div class="operation" v-show="!player[0].is_operation&&animate.animate1==1&&(player[0].playing_status>2||((player[0].hu_flag>0||player[0].gang_flag>0)&&player[0].playing_status==2))">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation1.png" class="bian" />
				<div class="button" v-on:click="click(4,player[0].playing_status)" v-show="player[0].playing_status>2" >
					<div class="back"></div>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation4.png" class="quanGuo" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/guo.png" class="textGuo" />	
				</div>	
				<div class="button" v-on:click="click(5)" v-show="player[0].playing_status==3||player[0].playing_status==4">
					<div class="back"></div>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation3.png" class="quan" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/peng.png" class="text" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zib1.png" class="text1" />
				</div>			
				<div class="button" v-on:click="click(6,3)" v-show="player[0].playing_status==4">
					<div class="back"></div>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation3.png" class="quan" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/gang.png" class="text" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zib1.png" class="text1" />
				</div>	
				...
				<div class="button" v-on:click="click(7)" v-show="player[0].playing_status==2&&player[0].hu_flag>0">
					<div class="back"></div>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/hu.png" class="text"/>
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation3.png" class="quan" />
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zib1.png" class="text1" />
				</div>				
				...
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/operation2.png" class="bian" />
				<div class="card" v-show="player[0].playing_status==5">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang1.png" class="outer" />
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(game.qianggang_card%100)+'.png'" class="inner" v-if="game.qianggang_card>0" />
				</div>
			</div><!---->
		</div>
		<!--别人的麻将-->
		<div class="others" >
			<div class="player2"  v-if="player[1].account_status==4">
				<div class="cardNew" v-show="player[1].cardNew.isShow&&!player[1].end_show" v-bind:style="'top:'+(-player[1].pengGang.length*4.5+27)+'%;'">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang3.png" class="outer" />	
				</div>
				<div class="cardNew1" v-if="player[1].end_show&&player[1].cardNew.isShow&&player[1].cardNew.card!=-1"  v-bind:style="'top:'+(-player[1].pengGang.length*1.3+20)+'%;'">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang8.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[1].cardNew.card%100)+'.png'" class="inner" />	
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="player[1].cardNew.card<100" />
				</div>
				...
				<div class="pengGang" v-for="p in player[1].pengGang">
					...
					<div class="card0" v-bind:style="'margin-top: '+(5-(p.num*8.4))+'%;z-index: 33;'"  v-show="p.type==3">
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang10.png" class="outer" />
					</div>
			...
			<div class="player3"  v-if="player[2].account_status==4">
				<div class="cardNew" v-if="player[2].cardNew.isShow&&!player[2].end_show" style="margin-left:-4.5%;">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang5.png" class="outer" />	
				</div>
				<div class="cardNew1" v-if="player[2].end_show&&player[2].cardNew.isShow&&player[2].cardNew.card!=-1" style="margin-left:-4.5%;">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[2].cardNew.card%100)+'.png'" class="inner" />	
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="player[2].cardNew.card<100" />
				</div>
				...
				<div class="pengGang" v-for="p in player[2].pengGang">
					<div class="card" v-bind:style="'margin-left:'+(0-(p.num*11))+'%;'">
						<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" v-show="p.type==1||p.type==2"/>
						<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(p.card%100)+'.png'" class="inner" />
					</div>
			...
			<div class="player4"  v-if="player[3].account_status==4">
				<div v-for="c in player[3].card" class="card"  v-bind:style="'margin-top:-'+(1.8*(c.num))+'%;z-index:'+(20-c.num)+';top:'+(51+player[3].pengGang.length*4.5)+'%;'" v-show="!player[3].end_show">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang4.1.png" class="outer"/>
				</div>
				...
				<div class="cardNew1" v-if="player[3].end_show&&player[3].cardNew.isShow&&player[3].cardNew.card!=-1" v-bind:style="'top:'+(61+player[3].pengGang.length*1.3)+'%;'">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang8.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[3].cardNew.card%100)+'.png'" class="inner" />	
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/lai.png" class="lai" v-show="player[3].cardNew.card<100" />
				</div>
		...
		<div class="cardList" v-show="game.status==2">
			<div class="player1">
				...
				<div class="discard" v-if="player[0].cardSet>0">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[0].cardSet%100)+'.png'" class="inner" />
				</div>
			</div>			
			<div class="player2">
				...
				<div class="discard" v-if="player[1].cardSet>0">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang8.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[1].cardSet%100)+'.png'" class="inner" />
				</div>
			</div>		
			<div class="player3">
				...
				<div class="discard" v-if="player[2].cardSet>0">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang6.png" class="outer" />	
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[2].cardSet%100)+'.png'" class="inner" />
				</div>
			</div>
			<div class="player4">
				...
				<div class="discard" v-if="player[3].cardSet>0">
					<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/majiang8.png" class="outer" />
					<img v-bind:src="'<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards'+(player[3].cardSet%100)+'.png'" class="inner" />	
				</div>
			</div>
		</div>
		<!--最后一张牌标记-->
		<div class="currentCard"  >
			<div  class="player0" v-bind:style="'margin-left:'+((player[0].discard.length-1)%12*3.1)+'%;z-index: 31;margin-top: '+(player[0].discard.length>12?3.8:0)+'%;'" v-if="game.last_user==player[0].account_id&&player[0].discard.length>0">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/currentCard.gif" class="currentSign" v-if="player[0].discard[player[0].discard.length-1].show" />
			</div>
			<div  class="player1" v-bind:style="'margin-top:-'+((player[1].discard.length-1)%12*2.5)+'%;z-index: 31;margin-left: '+(player[1].discard.length>12?4:0)+'%;'" v-if="game.last_user==player[1].account_id&&player[1].discard.length>0">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/currentCard.gif" class="currentSign" v-if="player[1].discard[player[1].discard.length-1].show"/>
			</div>
			<div  class="player2" v-bind:style="'margin-right:'+((player[2].discard.length-1)%12*3.1)+'%;z-index: 31;margin-bottom: '+(player[2].discard.length>12?7.6:3.8)+'%;'" v-if="game.last_user==player[2].account_id&&player[2].discard.length>0">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/currentCard.gif" class="currentSign" v-if="player[2].discard[player[2].discard.length-1].show"/>
			</div>
			<div  class="player3" v-bind:style="'margin-top:'+((player[3].discard.length-1)%12*2.5)+'%;z-index: 31;margin-left: '+(player[3].discard.length>12?-8:-4)+'%;'" v-if="game.last_user==player[3].account_id&&player[3].discard.length>0">
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/currentCard.gif" class="currentSign" v-if="player[3].discard[player[3].discard.length-1].show"/>
			</div>			
		</div>
		<!--碰杠胡-->
		<div class="wordShow">
			<div v-for="p in player">	
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zifront.png" v-bind:class="'zi'+p.num+' animate1'" v-if="p.zi==1" />
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/peng2.png" v-bind:class="'zi'+p.num+' animate'" v-if="p.zi==1" />					
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zifront.png" v-bind:class="'zi'+p.num+' animate1'" v-if="p.zi==2" />
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/gang2.png" v-bind:class="'zi'+p.num+' animate'" v-if="p.zi==2" />
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/zifront.png" v-bind:class="'zi'+p.num+' animate1'" v-if="p.zi==3" />
				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/hu2.png" v-bind:class="'zi'+p.num+' animate'" v-if="p.zi==3" />
	...
	<div class="roundPause1" id="roundPause1" style="z-index: 70;display: none;">
		<img  crossOrigin="Anonymous"  src="" style="width: 100%;position: absolute;top:0;left: 0;height: 100%;" id="roundPause2"  />
		<div v-for="p in player"  v-bind:class="'playerStatus playerStatus' + p.num">
			<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/ready.png" v-show="p.account_status==2"/>
			<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/offline.png" v-show="p.online_status==0"/>
		</div>
		<div class="release">三分钟未开局，房间自动解散<a>{{game.countdown}}s</a></div>
		<div class="button buttonRight" >
			<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/rankb2.png"/>
		...
		<div class="audioRoom" id="vaudioRoom" v-show="editAudioInfo.isShow">
			...
			<div class="mainPart" >			
				...
				<div class="createTitle" style="height:4vh;">
					<!--<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/createroom2.png" />-->
				</div>	

				<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/cancel.png" class="cancelCreate" v-on:click="cancelAudioSetting"/>
					...
					<div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;">
						...
						<div class="selectList" >
							<div class="selectItem" style="margin-left:10px;" v-on:click="setBackMusic" >
								...
								<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/gou.png" v-show="editAudioInfo.backMusic==1"/>
					...
					<div class="selectPart" style="height:4vh;line-height:4vh;padding:0.8vh 0;">
						...
						<div class="selectList" >
							<div class="selectItem" style="margin-left:10px;" v-on:click="setMessageMusic">
								<div class="selectBox"></div>
								<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/gou.png" v-show="editAudioInfo.messageMusic==1"/>
								<div class="selectText">开启</div>
							</div>							
						</div>
					</div>
	...
	<div class="alert" v-show="isShowAlert">
		...
		<div class="mainPart">
			<!--<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/game/alertBox.jpg" class="backImg" />-->
			<div class="backImg">
...
<!-- 临时积分榜  -->
	<div class="roundPause" id="roundPause" style="z-index: 0;display: none;">
		<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/tempRank1.png" class="title">
		...
		<div class="infoPart">
			...
			<div class="positionList" v-for="p in playerBoard.score" v-bind:class="{true: 'scoresItemWin', false: 'scoresItemLose'}[p.account_score>0]">
				<div style="width: 12%;"><img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/winner.png" v-show="game.maxWin==p.account_score"></div>
		...
		<div class="button buttonLeft">
			<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/rankb1.png"/>
...
<!-- 排行  -->	
	<div class="ranking" id="ranking" style="display: none;">
		<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/majiang1.jpg" class="rankBack" />
		<div class="rankText">
			<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/majiang2.1.png" class="title" />
			...
			<div v-for="p in playerBoard.score" class="scoresItem" v-bind:class="{true: 'backB', false: 'backY'}[p.account_score>0]" v-show="p.account_id>0">
				<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/winner.png" v-show="game.maxWin==p.account_score">
				<div class="name">{{p.nickname}}</div>
				<div class="currentScores" ><a v-show="p.account_score>0" style="color:#000;">+</a>{{p.account_score}}</div>
			</div>
		</div>
		<img  crossOrigin="Anonymous"  src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/ranking/save.png" class="button" />
	</div>
<!-- end图片  -->	
	<div class="end" style="position: fixed;width: 100%;height:100%;top:0;left:0;z-index: 140;display: none;">
		...
		<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/common/rank_create.png" style="position: absolute;width: 30vw;top: 21%;left:50%;z-index: 140;margin-left: -13vw;margin-top: 80vw;" v-on:click="home()" v-show="game_staus==4"/>
	</div>
	 <!-- 绑定手机号码 -->
	...
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards21.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards22.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards23.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards24.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards25.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards26.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards27.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards28.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards29.png">	
	
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards41.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards42.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards43.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards44.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards45.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards46.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards47.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards48.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards49.png">	
	
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards61.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards62.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards63.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards64.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards65.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards66.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards67.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards68.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards69.png">

	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards80.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards83.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards86.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards89.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards93.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards96.png">
	<img src="<?php echo $image_url;?>files/d_<?php echo $dealer_num;?>/images/majiang/cards99.png">
</div>
</div>
...
<script type="text/javascript" src="<?php echo $base_url;?>files/d_2/js/majiang/majiang.js" defer></script>

 <!-- script type="text/javascript" src="<?php echo $file_url;?>files/d_<?php echo $dealer_num;?>/js/majiang/majiang17-1.0.0.min.js"></script --> 
</body>
</html>
