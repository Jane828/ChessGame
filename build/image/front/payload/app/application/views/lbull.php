...
<title>癞子斗牌房间<?php echo $room_number;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $base_url;?>files/css/lbull.css?_version=<?php echo $front_version;?>">
...
<body >
	...
	<style>
		...
		.layerGameScore .mainPart .gameStoreTitle span{ color:#7D2F00; font-size:4.6vw;   font-weight:bold; position:relative; z-index:10;}
    ...
    ?>
		...
		<div class="round" style="position: fixed;">{{game.round}}&nbsp;/&nbsp;{{game.total_num}}&nbsp;局</div>
        ...
        <div class="footPoint">
		    <div><img src="<?php echo $image_url;?>files/images/common/endPoint.png" alt="底分" class="footImg"><span class="baseScore">{{ruleInfo.customScore}}分</span></div>
	   </div>
        <!-- 积分榜，消息按钮 -->
		...
		<div class="table" id="table" style="position: relative; width: 100%; height: 100%; z-index: 80; overflow: hidden;">
			<img class="tableBack"  src="<?php echo $image_url;?>files/images/lbull/bk.jpg" style="position: absolute;top:0;left: 0;width: 100vw;height: 100vh" />
        ...
        <div class="mainPart">
			...
			<div class="gameStoreTitle">
				<span data-text='十人癞子斗牌战绩'>十人癞子斗牌战绩</span>
			</div>
        ...
        <div class="joinOrWatch" v-show="joinChoose.isShow">
            ...
            <div class="mainPart" >
                ...
                <div class="blueBack">
                    ...
                    <div class="selectPart" :style="'height:' + ruleInfo.rule_height + ';line-height:4vh;padding:0.8vh 0;'" v-if="ruleInfo.isCardbomb==1 || ruleInfo.isCardtiny==1 || ruleInfo.isCardfive==1 || ruleInfo.isCardfour==1">
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/lbull.js?_version=<?php echo $front_version;?>"></script>
