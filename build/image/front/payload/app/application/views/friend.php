...
.header .menu-item-checked .label-checked span {padding-left: 14px;text-align: left;font-size:14px;}
.header .menu-item-checked .label-no-checked span {padding-right: 14px;text-align: right;font-size:14px;}
...
.friends-list{position: absolute;top: 18vw;left: 3vw;background-color: rgba(255,255,255,0.1);border: 1px solid rgba(255,255,255,0.5);width: 94vw;border-radius: 5px;margin-bottom: 14vh;z-index: 80;}
.friends-list .list-ul{margin: 0 2vw 6px 2vw;}
.friends-list .list-ul .alif-li{color:#F3EFFC;margin-top: 6px;padding-left:3vw;}
.friends-list .list-ul .user-li {position: relative;background-color:rgba(39, 32, 92,0.5);height: 54px;margin-top: 6px;padding-left: 3vw;border: 1px solid rgba(13, 1, 39,0.2);border-radius: 3px;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}
...
<div class="main" ng-controller="myCtrl" style="display: none;">
    ...
    <div class="alert" ng-show="isShowAlertOperate">
		...
		<div class="mainPart" ng-class="alertTypeOperate==8?'mainPartNews':''">
            ...
            <div class="alertInput" ng-if="alertTypeOperate==9">
                <input type="text" placeholder="请输入好友游戏ID" ng-model="userID" />
            </div>
            ...
            <div class="alertInput" ng-if="alertTypeOperate==12">
                <input type="text" placeholder="请输入备注" ng-model="userAliases" />
            </div>
	...
	<img id="bodyBackground" src="<?php echo $image_url;?>files/images/hall/body.png"  style="width: 100%;height: auto;position: fixed;left: 0;top: 0;">
    <div class="header">
        <ul class="header-menu">
            ...
            <li class="menu-item menu-item-checked" ng-click="toggle()">
                <p>管理功能</p>
                <label class="label-text label-checked" ng-if="settingCheck"><span>开</span><i class="icon-btn icon-checked"><img src="<?php echo $image_url;?>files/images/friend/checked.png" /></i></label>
                <label class="label-text label-no-checked" ng-if="!settingCheck"><span>关</span><i class="icon-btn icon-no-checked"><img src="<?php echo $image_url;?>files/images/friend/no-checked.png" /></i></label>
            </li>
        </ul>
    </div>
    ...
    <!---好友列表start---->
    <div class="friends-list" ng-if="currentMenu=='list'">
    ...
    <!---好友列表end---->
    <!---小黑屋列表start---->
    <div class="friends-list" ng-if="currentMenu=='blacklist'">
...
<script type="text/javascript" src="<?php echo $base_url;?>files/js/friend.js?_version=<?php echo $front_version;?>"></script>
<script>
	wx.config({
        debug: false,
