        ...
        for (var i = 1; i < 10; i++) {
            for (var j = 0; j < 8; j++) {
                if (i == 1) {
                    ...
                    $(".memberCoin" + i + j).css({top: "43%",left: coinLeft3});
                } else if (i == 4) {
                    $(".memberCoin" + i + j).css({top: "27%",left: coinLeft4});
                } else if (i == 5) {
                    $(".memberCoin" + i + j).css({top: "6%",left: coinLeft5});
                } else if (i == 6) {
                    $(".memberCoin" + i + j).css({top: "6%",left: coinLeft6});
                } else if (i == 7) {
                    $(".memberCoin" + i + j).css({top: "27%",left: coinLeft7});
                } else if (i == 8) {
                    $(".memberCoin" + i + j).css({top: "43%",left: coinLeft8});
                } else if (i == 9) {
