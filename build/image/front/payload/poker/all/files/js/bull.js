...
var httpModule = {
    getActivityInfo: function() {
        var postData = { "account_id": userData.accountId, "dealer_num": globalData.dealerNum, "session": globalData.session,'room_number' : globalData.roomNumber ,'game_type' : 5 };
    ...
    getScoreInfo: function () {
        Vue.http.post(globalData.baseUrl + 'f/scoreStat', {'type':5}).then(function (response) {
            var bodyData = response.body;
