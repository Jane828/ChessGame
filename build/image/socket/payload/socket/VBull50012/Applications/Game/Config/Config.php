...
class Config
{
	...
	const Timer_Port =  TIMER_PORT;//"50019";
	const Timer_Address =  TIMER_ADDR;//"127.0.0.1";

	const GameClient_Port =  GAME_CLIENT_PORT;//"50012";
	const GameServer_Port =  GAME_SERVER_PORT;//"50011";
	const GameWeb_Port    =  GAME_WEB_PORT;//"50010";
    ...
    const Log_Dir	=	 LOG_DIR2;//LOG_DIR . "vbull6/";
