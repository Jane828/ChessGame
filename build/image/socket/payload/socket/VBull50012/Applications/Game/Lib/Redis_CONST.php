...
{	
	...
	*/
    ...
    const Room_Field_ClubId             = "clubId"; // 房主所在公会
    const Room_Field_BeanType           = "beanType";   // 准入 1：300豆 2：1000豆 3：2000豆 4：5000豆
	...
	/*
		...
		hash
	*/
	const RoomScore_Key					= "93:RoomScore:[roomid]";
	...
	/*
		...
		hash
	*/
	const AccountStatus_Key				= "93:AccStatus:[roomid]";
	...
	/*
		用户是否扣了房卡  hash
	*/
	const TicketChecked_Key				= "93:TicketChecked:[roomid]";
	...
	/*
		...
		有序集合
			...
			value	:	account_id
	*/
	const RoomSequence_Key				= "93:RoomSeq:[roomid]";
	
	/*
		叫分
		hash
	*/
	const Multiples_Key					= "93:Multiples:[roomid]";
	...
	/*
		...
		hash
	*/
	const ShowCard_Key				= "93:Show:[roomid]";
	
	/*
		手牌
		hash
	*/
	const Card_Key				= "93:Card:[roomid]";
	...
	*/
	...
	/*
		游戏局玩家队列  
	*/
	const PlayMember_Key				= "93:PlayMem:[roomid]";
