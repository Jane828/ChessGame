...
class Config{
	...
	const Timer_Port =  TIMER_PORT;//"20059";
	const Timer_Address =  TIMER_ADDR;//"127.0.0.1";

	const GameClient_Port =  GAME_CLIENT_PORT;//"20052";
	const GameServer_Port =  GAME_SERVER_PORT;//"20051";
	const GameWeb_Port    =  GAME_WEB_PORT;//"20050";
    ...
    const Log_Dir	=	 LOG_DIR2;//LOG_DIR . "vflower6/";
