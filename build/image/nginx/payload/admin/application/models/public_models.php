...
class Public_Models extends Db_Models
{
	...
	*/
	public function getDealerJournal($arrData)
	{
		...
		$journal_where = 'create_time>='.$from_timestamp.' and create_time<'.$to_timestamp.' and object_type in ('.Game_CONST::DObjectType_Recharge.','. Game_CONST::DObjectType_Reward .') and is_delete=0';
