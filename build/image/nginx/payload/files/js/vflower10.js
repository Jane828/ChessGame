...
var httpModule = {
    ...
    getScoreInfo: function () {
        Vue.http.post(globalData.baseUrl + 'f/scoreStat', {'type':95}).then(function (response) {
...
var viewMethods = {
    ...
    selectCoin: function(num, board) {
        ...
        if (num == 1) {
            ...
            top = 146;left = -98;
        } else if (num == 10) {top = 238;left = -58;}
...
var gameWidth = document.body.clientWidth + 'px', gameHeight = document.body.clientHeight + 'px' ;
