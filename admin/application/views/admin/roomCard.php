...
<body id="body" >
	...
	<div id="app-main">
		...
		<div class="body">
			<div class="box">
				<div class="mainPart"  >
<!--					<div class="headTitle">房卡来源</div>-->
                    <div class="headTitle" style="height: 60px;">
                        <div style="float: left;margin-right:15px; ">房卡来源</div>
					...
					<div class="search">
						<div class="item" v-for="(u,index) in roomCard.userList" v-bind:class="{true: 'select', false: 'notselect'}[u.isSelect]">
							...
							<img class="from" src="<?php echo $base_url;?>files/images/cms/adNext.png" v-show="index!=roomCard.userList.length-1"/>
						</div>
					</div>
					...
					<table class="roomCardList" cellspacing="0" >
						...
						<tr class="item" v-for="c in roomCard.data">
							...
							<td ><div class="cardCancel" v-show="adminshow" v-on:click="cardCancel(c.account_id,c.ticket_count)">注销房卡</div></td>
...
$(document).ready(function() {
    $('#reservation').daterangepicker(null, function(start, end, label) {
        ...
        httpModule.getRoomCardSource(globalData.account_id);
    });
...
var httpModule = {
	getRoomCardSource: function (id) {
    	appData.request_3 = 1;
        Vue.http.post(globalData.baseUrl + 'game/getRoomCardSource', {
            	...
            	if(appData.roomCard.total_page>1){
					 $(".tcdPageCode").createPage({
	                    ...
	                    backFn:function(p){
	                        ...
	                        httpModule.getRoomCardSource(id);
	                    }
	                });
				}    
...
var viewMethods = {
	...
	listBreak: function (id) {
		...
		httpModule.getRoomCardSource(appData.roomCard.userList[appData.roomCard.userList.length-1].account_id);
    },
