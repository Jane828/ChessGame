    ...
    public static function dispatcherOpt($req_ary) {
        ...
        if (isset($req_ary['operation'])) {
            switch ($req_ary['operation']) {
                ...
                case 'PutPrize':        //放宝
                    $Room_Model = new Play_Model();
                    $result     = $Room_Model->putPrize($req_ary);
                    break;
                ...
                case 'StopBet':        //停止下注
                    $Room_Model = new Play_Model();
                    $result     = $Room_Model->StopBet($req_ary);
                    break;
                case 'ShowPrize':        //开奖
                    $Room_Model = new Play_Model();
                    $result     = $Room_Model->showPrize($req_ary);
                    break;

                case 'ShowChips':        //查看用户所有下注信息
                    $Room_Model = new Play_Model();
                    $result     = $Room_Model->showChips($req_ary);
                    break;
