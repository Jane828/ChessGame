...
{	
	...
	*/
	...
	/*
		...
		hash
	*/
	const RoomScore_Key					= "91:RoomScore:[roomid]";
	...
	/*
		...
		hash
	*/
	const AccountStatus_Key				= "91:AccStatus:[roomid]";
	...
	/*
		用户是否扣了房卡  hash
	*/
	const TicketChecked_Key				= "91:TicketChecked:[roomid]";
	...
	/*
		...
		有序集合
			...
			value	:	account_id
	*/
	const RoomSequence_Key				= "91:RoomSeq:[roomid]";
	
	/*
		叫分
		hash
	*/
	const Multiples_Key					= "91:Multiples:[roomid]";
	...
	/*
		...
		hash
	*/
	const ShowCard_Key				= "91:Show:[roomid]";
	
	/*
		手牌
		hash
	*/
	const Card_Key				= "91:Card:[roomid]";
	...
	*/
	...
	/*
		游戏局玩家队列  
	*/
	const PlayMember_Key				= "91:PlayMem:[roomid]";
