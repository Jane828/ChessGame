...
class Gateway
{
    ...
    {	
	if($message != "@"){
        	var_dump("<--sendToClient-->   client_id:$client_id   message:$message");
	}
//        echo("use echo function client_id:$client_id   message:$message\n");
    ...
    {
        var_dump("<--sendToCurrentClient--> message:$message");
    ...
    {
        var_dump("<--sendToGroup-->   client_id:$group   message:$message");
        $gateway_data         = GatewayProtocol::$empty;
