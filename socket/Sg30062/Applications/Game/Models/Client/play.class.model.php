...
class Play_Model extends Public_Model
{
	...
	*/
	public function chooseMultiples($arrData)
	{
		...
		$multiples = Config::PlayerCanBet_1;
		if(isset($data['multiples']) && in_array($data['multiples'], [Config::PlayerCanBet_1,Config::PlayerCanBet_2,Config::PlayerCanBet_3,Config::PlayerCanBet_4]))
		{
			// $this->logMessage('error', "function(chooseChip):lack of multiples"." in file".__FILE__." on Line ".__LINE__);
			// return $this->_missingPrameterArr($operation,"multiples");
			$multiples = $data['multiples'];
		}
	...
	*/
	public function showCard($arrData)
	{
		...
		$cards_result = $this->calculateCardValue($room_id, $account_id, $card_info);
