...
class Redis_CONST {
    ...
    */
    ...
    const Room_Field_HasGhost        = "hasGhost";              //增加开启癞子,默认0表示不开启
    ...
    /*
        ...
        hash
    */
    const RoomScore_Key        = "6:RoomScore:[roomid]";
    ...
    /*
        ...
        hash
    */
    const AccountStatus_Key = "6:AccStatus:[roomid]";
    ...
    /*
        用户是否扣了房卡  hash
    */
    const TicketChecked_Key = "6:TicketChecked:[roomid]";
    ...
    /*
        ...
        有序集合
            ...
            value	:	account_id
    */
    const RoomSequence_Key = "6:RoomSeq:[roomid]";

    /*
        叫分
        hash
    */
    const Multiples_Key        = "6:Multiples:[roomid]";
    ...
    /*
        ...
        hash
    */
    const ShowCard_Key = "6:Show:[roomid]";

    /*
        手牌
        hash
    */
    const Card_Key        = "6:Card:[roomid]";
    ...
    */
    ...
    /*
        游戏局玩家队列
    */
    const PlayMember_Key = "6:PlayMem:[roomid]";
    ...
    */
    ...
    /*
        ...
        观战
    */
    const RoomAudience_Key     = "6:RoomAud:[roomid]";
    const RoomAudienceInfo_Key = "6:RoomAudInfo:[roomid]";
