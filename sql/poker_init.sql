...
CREATE TABLE IF NOT EXISTS `bull_room`  (
  ...
  `game_type` tinyint(4) NOT NULL DEFAULT 5 COMMENT '游戏类型',
  `total_num` tinyint(4) NOT NULL DEFAULT 10 COMMENT '房间最大局数',
  `player_max_num` tinyint(4) NOT NULL DEFAULT 6 COMMENT '房间最大人数',
  `times_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '倍数规则：1，2，3',
  `club_id` int(11) NOT NULL DEFAULT 1 COMMENT '公会ID',
  `box_number` int(19) NOT NULL DEFAULT 0 COMMENT '包厢号,0:普通,其它:包厢号',
...
CREATE TABLE IF NOT EXISTS `dealer_account`  (
  ...
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户手机号',
...
CREATE TABLE IF NOT EXISTS `manage_member`  (
  ...
  `attention` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否关注好友包厢房间,1:是,0:否',
  `is_delete` tinyint(2) NOT NULL,
  `aliases` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '' COMMENT '群主给别名',
  `update_time` int(11) NOT NULL,
  `update_appid` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` int(11) NOT NULL,
  `create_appid` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `wechat_account`  (
  ...
  `capital` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '@' COMMENT '昵称首字符分类',
...
) ENGINE = InnoDB AUTO_INCREMENT = 26026 CHARACTER SET = utf8mb4 COLLATE = utf8_general_ci COMMENT = '微信账号' ROW_FORMAT = Compact;
...
CREATE TABLE IF NOT EXISTS `box_info` (
  `box_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `account_id` int(11) NOT NULL DEFAULT '0' COMMENT '创建人',
  `box_number` bigint(19) NOT NULL DEFAULT '0' COMMENT '包厢号',
  `game_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '游戏类型',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '包厢状态0:暂停,1:开启',
  `room_count` int(11) NOT NULL DEFAULT '0' COMMENT '创建房间数',
  `box_name` varchar(255) NOT NULL DEFAULT '' COMMENT '包厢自定义标题',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `config` varchar(512) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建房间配置',
  PRIMARY KEY (`box_id`),
  KEY `idx_aid` (`account_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='包厢的配置信息';

-- ----------------------------
-- Table structure for box_room
-- ----------------------------
CREATE TABLE IF NOT EXISTS `box_room` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动增长主键',
  `box_id` int(11) NOT NULL DEFAULT '0' COMMENT '包厢号',
  `box_number` bigint(19) NOT NULL DEFAULT '0' COMMENT '包厢号',
  `room_id` int(11) NOT NULL DEFAULT '0' COMMENT '房间记录id',
  `room_number` int(11) NOT NULL DEFAULT '0' COMMENT '房间号',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_bid` (`box_id`) USING BTREE,
  KEY `idx_bnb` (`box_number`) USING BTREE
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='包厢房间';
